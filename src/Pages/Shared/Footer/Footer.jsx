const Footer = () => {
  return (
    <>
      ...
      <footer id="footer" className="footer mt-[20%] md:mt-[15%] p-10">
        <div className="waves">
    ...
    <p className=" opacity-75">Made with 🤍 by Khawaja</p> */}
        <aside>
          <div className="font-YSerif flex items-center text-2xl font-bold">
            <img
              className=" -ml-2 -mr-1 w-12 md:w-12"
          ...
          <p>Providing satisfying services since 2012</p>
        </aside>
        <nav>
